...
{
    /// <summary>
    /// Classe de extensão para objetos UrlHelper, utilizados em páginas razor.
    /// </summary>
    public static class UrlHelperExtensions
    {
        ...
        /// <param name="actionName">Nome da action que será invocada.</param>
        /// <returns>A URL absoluta.</returns>
        public static string GetAbsoluteUrl(this UrlHelper url, string areaName, string subAreaName,
            string controllerName, string actionName)
        {
            var uri = GetAbsoluteUrl(url, controllerName, actionName, new { area = areaName, subarea = subAreaName, });
            return uri;
        }
        ...
        /// <param name="actionName">Nome da action que será invocada.</param>
        /// <returns>A URL absoluta.</returns>
        public static string GetAbsoluteUrl(this IUrlHelper url, string areaName, string subAreaName,
            string controllerName, string actionName)
        {
            var uri = GetAbsoluteUrl(url, controllerName, actionName, new { area = areaName, subarea = subAreaName, });
            return uri;
